        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#">欢迎：<span class="text text-primary">${admin.name}</span></a></li>
                    <li class="dropdown">
                        <a href="${path}/admin/excp" >退出 <span class="glyphicon glyphicon-log-out"></span></a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/test/echartsGoEasy.jsp')">用户统计</a>
                                </button><br><br>
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/test/chinaAll.jsp')">
                                       用户分布
                                    </a>
                                </button>
                            </div>
                        ...
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <a href="javascript:$('#mainId').load('${path}/category/showCategory.jsp')">类别管理</a>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <button class="btn btn-success">类别信息</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-danger">
                                    <a href="javascript:$('#mainId').load('${path}/admin/admin.jsp')">管理员信息</a></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                            <div class="panel-body">
                                <button class="btn btn-primary">
                                    <a href="javascript:$('#mainId').load('${path}/log/log.jsp')">日志信息</a>
                                </button>
                            </div>
                        </div>
                    </div>
