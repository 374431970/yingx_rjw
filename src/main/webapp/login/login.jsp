    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop("src","${path}/admin/enCode?d="+new Date().getTime());
            });

            //表单验证  设置验证规则
            $.extend($.validator.messages, {
                required: "<sapn style='color:red' >这是必填字段</span>",
                minlength: $.validator.format("<sapn style='color:red' >最少要输入 2 个字符</span>")
            });
            ...
            $("#loginButtonId").click(function(){
                ...
                if(isOk){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        dataType:"json",
                        data:$("#loginForm").serialize(),  //表单序列化获取表单数据     根据input的name获取对应的值
                        success:function(data){
                            if(data.status=="200"){
                                ...
                                //展示错误信息
                                $("#msgDiv").html("<sapn style='color:red' >"+data.message+"</span>");
                            }
                        }
                    })
                }
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input  minlength="2"  type="text" name="name" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/enCode">
