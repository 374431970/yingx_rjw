...
public class AliyunTests {
    ...
    //说明 有备注无需修改的位置请勿改动。
    //发送短信
    public static SendSmsResponse SendPhoneMsg(String phoneNumbers,String signName,String templateCode,String templateParam) throws ClientException {
    ...
    public static String sendPhoneCode(String phoneNumbers, String randomCode) throws ClientException {
        ...
        /*String phoneNumbers1="152425137674"; //手机号*/
    ...
    public static void main(String[] args) {
        String phoneNumbers="17835533740"; //手机号
